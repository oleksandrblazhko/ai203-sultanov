...
class Courses:
    ...
    def create_lesson(selfesteem):
        lesson_name = input("Введіть назву курсу")
    ...
    def data_change(selfesteem):
        selfesteem.course_date = input("Нова дата курсу")
        return selfesteem.course_date

    def time_change(selfesteem):
        selfesteem.time = input("Новий час курсу")
        return selfesteem.time

    def lesson_change(selfesteem):
        selfesteem.lesson_name = input("Нова назва курсу")
